...
const PAYMENT_METHODS = ['现金', '支付宝', '微信', '银行转账'];
        ...
        <div className="space-y-6 pb-32">
          ...
          <div className="flex">
            ...
            <button
              ...
              className="px-3 py-4 border-y-4 border-r-4 border-slate-300 dark:border-slate-700 rounded-r-2xl bg-white dark:bg-slate-900 hover:border-blue-500 font-semibold text-sm whitespace-nowrap"
            >
              {currency}
            </button>
          </div>
              ...
              {CATEGORIES.map((cat, idx) => (
                <button
                  ...
                  className={`py-2 px-2 font-semibold transition text-xs ${
                    category === cat.key
                      ? `${cat.bg} ${cat.text} ring-2 ring-offset-2 ring-blue-400 relative z-10`
                      : `${cat.bg} ${cat.text} opacity-70 hover:opacity-100`
          ...
          <div className="flex items-center justify-between border-4 border-slate-300 dark:border-slate-700 rounded-2xl bg-white dark:bg-slate-900 px-4 py-4">
            ...
            >
              ...
              <div className="w-10 h-10 rounded-full bg-blue-500 text-white flex items-center justify-center font-bold">
                {selectedPayerName.charAt(0).toUpperCase()}
              </div>
            </button>
          </div>
          ...
          <div className="border-4 border-slate-300 dark:border-slate-700 rounded-2xl bg-white dark:bg-slate-900 p-4">
            <div className="mb-4 flex items-center justify-between">
              ...
              <button
                ...
                className="px-3 py-1 text-xs font-semibold bg-slate-200 dark:bg-slate-800 rounded-full hover:bg-slate-300 dark:hover:bg-slate-700"
              >
                全部人
              </button>
            </div>
            ...
            <div className="mb-4 min-h-16 border-2 border-dashed border-slate-300 dark:border-slate-700 rounded-lg p-3 flex flex-wrap gap-2 items-center">
              ...
              {owedFriendIds.length === 0 && (
                <span className="text-sm text-slate-500">点击下方选择欠钱人</span>
              )}
            </div>
              ...
              {tripMembers.map((friend) => (
                <motion.button
                  ...
                  className={`flex flex-col items-center gap-1 p-2 rounded-lg transition ${
                    owedFriendIds.includes(friend.id)
          ...
          <div className="border-4 border-slate-300 dark:border-slate-700 rounded-2xl bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-950 dark:to-emerald-900 p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className="px-3 py-1 text-xs font-semibold bg-emerald-600 text-white rounded-full hover:bg-emerald-500 transition"
              >
                重新获取
              </button>
            </div>
